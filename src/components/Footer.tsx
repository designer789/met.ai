...
// Reuse the same social links from Header for consistency
const socialLinks = [
  {
    name: 'Twitter',
...
// Navigation menu items for the footer
const footerNavItems = [
  { label: 'Home', href: '#hero' },
  { label: 'Marketplace', href: '#marketplace' },
  { label: 'Infrastructure', href: '#infrastructure' },
  { label: 'Why Met.AI', href: '#why-metai' },
  ...
  return (
    <footer className="bg-zinc-900 border-t border-zinc-800">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-zinc-800 mt-8 pt-8 flex flex-col md:flex-row justify-center items-center">
          <p className="text-zinc-500 text-sm">
            &copy; {currentYear} Met.AI. All rights reserved.
          </p>
